...
function WatchListPage({ Watchlist,handleRemoveFromWatchlist ,setWatchList}) {
            ...
            {Watchlist.filter((movieObj)=>{
              ...
              return (
                <tr key={movieObj.id} className="border-b-2">
                  ...
                  <td onClick={()=>handleRemoveFromWatchlist(movieObj)} className="text-red-800 cursor-pointer hover:underline"> Delete</td>
                </tr>
              );
            })}
          </tbody>
